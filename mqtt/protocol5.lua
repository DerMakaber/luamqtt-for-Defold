...
local parse_packet_connect_input = protocol5.parse_packet_connect_input
...
function protocol5.parse_packet_connect_input(input, version)
	...
	return protocol5._parse_packet_connect_continue(input, packet)
