...
local parse_packet_connect_input = protocol4.parse_packet_connect_input
...
function protocol4.parse_packet_connect_input(input, version)
	...
	return protocol4._parse_packet_connect_continue(input, packet)
